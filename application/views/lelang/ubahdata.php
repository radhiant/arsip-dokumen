   ...
   <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1">
       ...
       <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10">
           <div class="card">
               ...
               <div class="card-body">
                   <form action="<?= base_url(); ?>/lelang/ubah" method="POST">
                   <table class="table table-bordered">\
                     <input type="hidden" name="id" value="<?= $l->id_lelang ?>">
                     <tr>
                     <td width="5%"><label for="nmdokumen" class="col-form-label">Nama Projek</label></td>
                     <td colspan="3">
                       <div class="form-group">
                           <textarea name="namaP" rows="4" class="form-control" cols="80" ><?= $l->projek ?></textarea>
                       </div>
                     </td>
                     </tr>
                       <tr>
                       ...
                       <td colspan="3">
                         <div class="form-group">
                             <textarea name="opd" rows="4" class="form-control" cols="80" ><?= $l->OPD ?></textarea>
                         </div>
                       </td>
                       </tr>
                       ...
                       <td colspan="3">
                       <div class="form-group">
                           <input id="pembuat" type="text" class="form-control form-control-sm" name="kabkota" value="<?= $l->kabkota ?>" required>
                       </div>
                       </td>
                       </tr>
                       ...
                       <td width="15%">
                       <div class="form-group">
                           <input id="date" type="number" class="form-control form-control-sm" value="<?= $l->tahun ?>" name="tahun" required>
                       </div>
                     </td>
