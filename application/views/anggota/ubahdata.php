                            ...
                            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" name="id" id="id" value="<?= $a->id_anggota ?>">
                                            <tr>
                                            <td width="20%"><label for="nim" class="col-form-label">NIM</label></td>
                                            <td>
                                            <div class="form-group">
                                                <input id="nim" type="number" class="form-control form-control-sm" name="nim" value="<?= $a->nim ?>">
                                            </div>
                                            </td>
                                            </tr>
                                            ...
                                            <td>
                                            <div class="form-group">
                                                <input id="namaA" type="text" class="form-control form-control-sm" name="namaA" value="<?= $a->nama_anggota ?>">
                                            </div>
                                            </td>
                                            </tr>
                                            ...
                                            <td>
                                            <div class="form-group">
                                                <input id="tmpt" type="text" class="form-control form-control-sm" name="tmpt" value="<?= $a->tempat_lahir ?>">
                                            </div>
                                            </td>
                                            </tr>
                                            ...
                                            <td>
                                            <div class="form-group">
                                                <input id="tglhr" type="date" class="form-control form-control-sm" name="tglhr" value="<?= $a->tgl_lahir ?>">
                                            </div>
                                            </td>
                                            </tr>
                                            ...
                                            <td>
                                            <div class="form-group">
                                                <input id="prodi" type="text" class="form-control form-control-sm" name="prodi" value="<?= $a->prodi ?>">
                                            </div>
                                            </td>
                                            </tr>
                                            ...
                                            <td>
                                            <div class="form-group">
                                                <input id="thn" type="number" class="form-control form-control-sm" name="thn" value="<?= $a->thn_masuk ?>">
                                            </div>
                                            </td>
                                            </tr>
