   ...
   <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1">
       ...
       <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10">
           <div class="card">
               ...
               <div class="card-body">
                   <form action="<?= base_url(); ?>legalitas/prosesubahupload" method="POST" enctype="multipart/form-data">
                   <table class="table table-bordered">
                    ...
                    <tr>
                      <td colspan="4">
                        <input type="hidden" name="flama" value="<?= $l->file_upload ?>">
                        File Sebelumnya <b><?= $l->file_upload ?></b>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="4">
